...
var _notifyNewConfig = function (user_id, new_config_content){
    return dao.updateUserConfig(user_id, new_config_content).then(
        ...
        function (config_id, updated_at, config_content){
            return fb.setUserConfiguration(user_id, config_content, updated_at, config_id);
        },
        function (error){
            return AV.Promise.error(error);
        }
...
exports.notifyNewConfig = function (user_id, new_config_content){
    return _notifyNewConfig(user_id, new_config_content);
};

exports.notifyNewConfigBatch = function (user_id_list, config_content_list){
    ...
    work.setWorker(function (job, resolve, reject){
        ...
        _notifyNewConfig(user_id, config).then(
            function (msg){
                console.log(msg);
                resolve(msg);
            },
